function [outputdir, allrois] = ms_SetExpProps_UpDown(dicom_dir)
...
paradigm.WaitBegin = 25; % number of TRs to wait until detrending starts
paradigm.FT = 15; % condition: Finger Tapping (FT)
paradigm.Rest = 30; % condition: Rest
paradigm.Regulate = 35; % condition: Regulate
paradigm.NumBlocks = 8; % A block is a sequence of trials defined above
